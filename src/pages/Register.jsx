        ...
        <>
            <style>{`
                ...
                * { box-sizing: border-box; }
                ...
                /* Prevent column children from overflowing */
                .rg-row > .rg-field {
                    min-width: 0;
                    margin-bottom: 15px;
                }
                ...
                /* ── INPUT WRAP: single clean definition ── */
                .rg-input-wrap {
                    display: flex;
                    align-items: center;
                ...
                .rg-strength-label { font-size: 11px; font-weight: 600; }
                            ...
                            <div className="rg-field">
                                ...
                                {pwStrength && (
                                    <div className="rg-strength-bar-bg">
                                        <div className="rg-strength-bar-fill" style={{ width: pwStrength.w, background: pwStrength.color }} />
                                    </div>
                                )}
                            </div>
